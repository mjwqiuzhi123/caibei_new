...
window.location.href = "${pageContext.request.contextPath}/admin/find/findContentAddPage.json";
}
</script>
</head>
<body>
    ...
    <tbody>
    <c:forEach var="findContent" items="${findContentList}">
	    <tr id="divtr">
		   <td style="height: 50px">${findContent}</td>
	    </tr>
    </c:forEach>
    </tbody>
    </table>
