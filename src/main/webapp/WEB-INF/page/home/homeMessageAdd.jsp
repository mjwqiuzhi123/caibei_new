...
<div class="place">
    ...
    <ul class="placeul">
    <li><a href="#">平台管理</a></li>
    <li><a href="#">首页信息管理</a></li>
    <li><a href="#">首页信息录入</a></li>
    </ul>
    </div>
    <form action="${pageContext.servletContext.contextPath}/admin/home/homeMessageAdd.json" method="post" enctype="multipart/form-data">
	    <div class="formbody">
